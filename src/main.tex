...
\newcommand{\sysname}{FlashDMoE\xspace}

\providecommand{\alltoall}{\emph{AllToAll}\xspace}
\providecommand{\allreduce}{\emph{AllReduce}\xspace}
\providecommand{\allgather}{\emph{AllGather}\xspace}
\providecommand{\ltol}{\textsc{LayerToLayer}\xspace}
\providecommand{\reducescatter}{\textsc{ReduceScatter}\xspace}

\title{\sysname: Fast Distributed MoE in a Single Kernel}
\author{%
    Osayamen Jonathan Aimuyo\thanks{Correspondence to \texttt{osayamen@stanford.edu}} \\
    Cornell University\\
